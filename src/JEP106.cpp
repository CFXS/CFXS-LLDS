...
static const char *jedec_id1[] = {
    ...
    "Dialog",
    "Media Vision",
    "Numonyx (Level One Communication)",
};
static const char *jedec_id2[] = {
    ...
    "Mushkin Enhanced Memory (Ramtron)",
...
static const char *jedec_id3[] = {
    ...
    "Actrans System Inc.",
    "ALPHA Technologies",
    "Silicon Labratories, Inc. (Cygnal)",
    ...
    "Win Technologies",
    "Tachyon Semiconductor (ASIC Designs Inc)",
    "Extreme Packet Devices",
    "RF Micro Devices",
    "Siemens AG",
    "Sarnoff Corporation",
    "Itautec SA (Itautec Philco SA)",
    "Radiata Inc.",
    ...
    "HiNT Corporation",
    "Chiaro",
    "MDT Technologies GmbH (MCI Computer)",
...
static const char *jedec_id4[] = {
    ...
    "takeMS - Ultron AG (TakeMS International AG)",
    ...
    "Accton Technology",
    "Teradiant Networks",
    "Scaleo Chip (Europe Technologies)",
    "Cortina Systems",
    "RAM Components",
    "Raqia Networks",
    "ClearSpeed",
...
static const char *jedec_id5[] = {
    ...
    "PortalPlayer",
    "Zhiying Software",
    "ParkerVision, Inc. (Direct2Data)",
    "Phonex Broadband",
    "Skyworks Solutions",
    "Entropic Communications",
    "I'M Intelligent Memory Ltd. (Pacific Force Technology)",
    "Zensys A/S",
    "Legend Silicon Corp.",
    "sci-worx GmbH",
    "SMSC (Oasis Silicon Systems)",
    "Renesas Electronics",
...
static const char *jedec_id6[] = {
    ...
    "Xambala Inc.",
    "EADS Astrium",
    "Terra Semiconductor (ATO Semicon)",
    "Imaging Works, Inc.",
    "Astute Networks, Inc.",
    "Tzero",
    "Emulex",
...
template<typename T>
static const char *GetName(const T &set, uint8_t identity) {
    constexpr auto SET_LENGTH = sizeof(set) / sizeof(set[0]);
    if (identity < SET_LENGTH) {
        return set[identity];
    } else {
        return "Unknown";
    }
...
namespace CFXS::LLDS {
    ...
    const char *GetManufacturerName_JEP106(uint8_t continuation, uint8_t identity) {
        if (identity == 0) {
            return "Invalid";
        }

        switch (continuation) {
            case 0: return GetName(jedec_id1, identity);
            case 1: return GetName(jedec_id2, identity);
            case 2: return GetName(jedec_id3, identity);
            case 3: return GetName(jedec_id4, identity);
            case 4: return GetName(jedec_id5, identity);
            case 5: return GetName(jedec_id6, identity);
            case 6: return GetName(jedec_id7, identity);
            case 7: return GetName(jedec_id8, identity);
            case 8: return GetName(jedec_id9, identity);
